              ...
              <div className="col-md-8 col-sm-8 pull-right">
                <div className="post-loop clearfix">
                  ...
                  <div className="post-loop-info clearfix">
                    <h1><a href="#">Top rated nature photography images list</a></h1>
                    <ul className="entry-meta">
                      <li><i className="fa fa-calendar"></i>07 June 2014 </li>
                      <li><i className="fa fa-comments"></i><a href="#">7 Comments</a></li>
                    </ul>
                    <p>Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  elit visitae eriat consequat auctor eu in elit. className aptent taciti sociosqu ad litora torquent per conubia Igor nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna euro felis dapibus condimentum sit amet a auguexed elit. </p>
                  </div>
                  {/*post-loop-info*/}
                  <div className="post-footer clearfix"> <a href="post.html">read more <i className="fa fa-long-arrow-right"></i></a>
                ...
                <div className="post-loop clearfix">
                  <div className="post-thumbnail"><img src={placeholder} alt="" /><a href="post.html"><i className="fa fa-link"></i></a></div>
                  <div className="post-loop-info clearfix">
                    <h1><a href="#">Clear viewed wild photography images list</a></h1>
                    <ul className="entry-meta">
                      <li><i className="fa fa-calendar"></i>07 June 2014 </li>
                      <li><i className="fa fa-comments"></i><a href="#">7 Comments</a></li>
                    </ul>
                ...
                <div className="post-loop clearfix">
                  <div className="post-thumbnail"><img src={placeholder} alt="" /><a href="post.html"><i className="fa fa-link"></i></a></div>
                  <div className="post-loop-info clearfix">
                    <h1><a href="#">Viewed building photography images list</a></h1>
                    <ul className="entry-meta">
                      <li><i className="fa fa-calendar"></i>07 June 2014 </li>
                      <li><i className="fa fa-comments"></i><a href="#">7 Comments</a></li>
                    </ul>
